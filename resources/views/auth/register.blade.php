    ...
    <div class="w-full max-w-md">
      ...
      <div class="text-center mb-8">
        <div class="inline-flex items-center gap-2 mb-4">
          ...
          <span class="font-bc font-700 tracking-[.2em] text-f1r text-xs uppercase">Registro</span>
          <div class="h-px w-8 bg-f1r"></div>
        </div>
        <h1 class="font-bebas text-5xl text-white tracking-wide">Crear Cuenta</h1>
        <p class="font-barlow text-gray-500 text-sm mt-2">Únete al campeonato de Fórmula 1 2026</p>
      </div>
      ...
      <div class="login-card p-8">
        <form method="POST" action="{{ route('register') }}">
          ...
          <div class="mb-5">
            <label for="name" class="f1-label">Nombre</label>
            <input id="name" type="text" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus
              placeholder="Tu nombre"
              class="f1-input {{ $errors->has('name') ? 'is-invalid' : '' }}">
            @error('name')
          ...
          <div class="mb-5">
            <label for="password" class="f1-label">Contraseña</label>
          ...
          <div class="mb-7">
            <label for="password-confirm" class="f1-label">Confirmar Contraseña</label>
        ...
        <div class="text-center">
          <span class="font-barlow text-gray-600 text-sm">¿Ya tienes cuenta?</span>
